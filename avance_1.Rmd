...
## Estrategia N°2
Estimación de la Biomasa a través de la imputación del volumen ( a través de DAP y Altura)
```{r}
...
## Estrategia N°3
Estimación de la biomasa a través de las funciones de volumen utilizadas pero con alturas de literatura
```{r}
dbase$anho.med <- 2020
db.imp <- dbase
db.imp$h.ori <- db.imp$htot
